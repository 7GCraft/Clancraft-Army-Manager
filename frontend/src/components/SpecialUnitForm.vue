    ...
    <div class="w-96 mt-1 mb-2">
      ...
      <form class="border border-black px-1" @submit.prevent="submitForm">
        <div class="border border-black px-2 py-2 my-2 mx-1">
          ...
          <div class="form-control mt-1"></div>
          <div class="form-control mt-1">
            <label for="unit-structure" class="mr-16">CC Faction</label>
            <input
              type="text"
              class="border border-black px-2"
              v-model.trim="selectedUnit['CC Faction']"
              id="unit-clancraft-faction"
            />
          </div>
          <div class="form-control mt-1">
            ...
            <input
              type="text"
              class="border border-black px-2"
              v-model.trim="selectedUnit['Atilla Faction']"
              id="unit-atilla-faction"
            />
          </div>
        ...
        <div class="border border-black px-2 py-2 my-3 mx-1">
          ...
          <div class="form-control mt-1">
            ...
            <select
              class="border border-black px-2"
              v-model.trim="selectedUnit.tier"
              id="unit-structure"
            >
              <option
                v-for="level in unitTierLevel"
                :value="level"
                :key="level"
              >
                {{ level }}
            ...
            <select
              class="border border-black px-2 w-[120px]"
              v-model.trim="selectedUnit.type"
              id="unit-structure"
            >
              <option v-for="tier in unitType" :value="tier" :key="tier">
                {{ tier }}
              </option>
            </select>
          </div>
          <div class="form-control mt-1">
            ...
            <input
              type="text"
              class="border border-black px-2"
              v-model.trim="selectedUnit['CC Units']"
              id="unit-clancraft-name"
            />
          </div>
          <div class="form-control mt-1">
            ...
            <input
              type="text"
              class="border border-black px-2"
              v-model.trim="selectedUnit['Atilla Units']"
              id="unit-atilla-units"
            />
          </div>
          ...
          <div class="form-control mt-1">
            ...
            <input
              type="text"
              class="border text-center border-black px-2 w-16 mr-2"
              v-model.number="selectedUnit.upkeep"
              id="unit-atilla-faction"
            />
        ...
        <h4 class="font-lg mt-1 font-semibold ml-1">
        ...
        <button
          class="ml-1 active:font-bold active:bg-green-300 px-2 text-white border h-12 bg-green-500 hover:bg-green-400 hover:font-semibold border-black my-2 mr-2"
          type="button"
          @click="addUnit"
        >
          Add Unit
        ...
        <button
          class="ml-1 active:font-bold active:bg-sky-300 px-2 text-white border bg-sky-500 hover:bg-sky-400 hover:font-semibold border-black border-lg h-12"
        >
          Submit
        </button>
      </form>
    ...
    <div class="flex-grow text-center mx-3 mt-1">
      ...
      <ul v-if="selectedUnits.length > 0">
        <li
          ...
          :key="unit.Number"
        >
          {{ unit.Name }} - {{ unit['CC Units'] }} -
          {{ unit['Atilla Units'] }} - {{ unit['CC Faction'] }} -
          {{ unit['Atilla Faction'] }} - {{ unit['Tier'] }}
